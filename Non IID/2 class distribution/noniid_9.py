...
attackers = [2,4,10,12,14,16,19,25,27]
...
with open('fashion_mnist_ba_pattern_acc_9','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('fashion_mnist_ba_pattern_basr_9','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list,fp)
with open('fashion_mnist_ba_pattern_rounds_9','wb') as fp:
