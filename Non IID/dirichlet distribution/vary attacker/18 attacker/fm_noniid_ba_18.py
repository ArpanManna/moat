...
global_backdoor_accuracy_list_attack = []
global_backdoor_accuracy_list_defense = []
...
for param in hyperparam_list:
  ...
  global_degree_noniid.append(param)
  ...
  attackers = [1,2,3,5,7,9,11,12,13,15,17,19,20,21,23,25,27,29]
  ...
  global_backdoor_accuracy_list_defense.append(backdoor_acc_test)
  ...
  global_backdoor_accuracy_list_attack.append(backdoor_acc_test)
  global_communication_rounds.append(rounds)
  global_poison_sample_list.append(poisoned_sample)
  global_attack_success_rates_list.append(attack_success_rate)
  global_misclassification_rates.append(misclassification_rates)
...
with open('acc_attack_18','wb') as fp:
  pickle.dump(global_accuracy_list_attack,fp)
with open('acc_defense_18','wb') as fp:
  pickle.dump(global_accuracy_list_defense,fp)
with open('basr_attack_18','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list_attack,fp)
with open('basr_defense_18','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list_defense,fp)
with open('fashion_mnist_ba_pattern_rounds_9_18','wb') as fp:
  pickle.dump(global_communication_rounds,fp)
with open('alpha_list_18','wb') as fp:
  pickle.dump(global_degree_noniid,fp)
with open('poison_list_18','wb') as fp:
  pickle.dump(global_poison_sample_list,fp)
