...
with open('basr_attack_0.5','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list_attack,fp)
with open('basr_defense_0.5','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list_defense,fp)
with open('fashion_mnist_ba_pattern_rounds_9_0.5','wb') as fp:
  pickle.dump(global_communication_rounds,fp)
with open('alpha_list_0.5','wb') as fp:
