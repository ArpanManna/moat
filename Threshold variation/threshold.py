...
def train(num_clients, num_rounds, train_loader, test_loader, backdoor_test_loader, losses_train, losses_test, 
          ...
          source,target,euclid_dist_roundwise, autoencoder_test_data_roundwise, shap_data_roundwise,threshold,defense):
...
def run(attackers_id, source_label, poisoned_label,sample_to_poison,client_data, test_data, backdoor_test_data,threshold,defense_flag):
...
threshold_list = [1.5,2.0,2.2,2.5,3.0]
for thshld in threshold_list:
  #thshld = t*0.1 + 1.7
  ...
  poisoned_sample, attack_success_rate, misclassification_rates,target_misclassification_rates,acc_test, backdoor_acc_test, global_updates, client_local_updates, rounds ,euclid_dists ,autoencoder_results, shap_data = run(attackers,8,3,-1,local_data_fl, test_data_1, backdoor_test_data,thshld,True)
...
with open('accuracy_fashion_lfa_threshold_18','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('comm_rounds_fashion_lfa_threshold_18','wb') as fp:
  pickle.dump(global_communication_rounds,fp)
with open('mcr_lfa_threshold_18','wb') as fp:
  pickle.dump(global_misclassification_rates,fp)
with open('t_mcr_lfa_threshold_18','wb') as fp:
  pickle.dump(global_target_misclassification_rates,fp)
with open('asr_lfa_threshold_18','wb') as fp:
  pickle.dump(global_attack_success_rates_list,fp)
with open('shap_threshold_18','wb') as fp:
