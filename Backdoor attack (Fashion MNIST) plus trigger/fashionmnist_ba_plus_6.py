...
with open('fashion_mnist_ba_plus_acc_6','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('fashion_mnist_ba_plus_basr_6','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list,fp)
with open('fashion_mnist_ba_plus_rounds_6','wb') as fp:
