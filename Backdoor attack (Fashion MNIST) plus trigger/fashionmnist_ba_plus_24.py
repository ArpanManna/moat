...
attackers = [0,1,2,3,4,5,7,8,9,10,12,13,15,16,18,19,20,21,23,24,25,26,27,28]
...
with open('fashion_mnist_ba_plus_acc_24','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('fashion_mnist_ba_plus_basr_24','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list,fp)
with open('fashion_mnist_ba_plus_rounds_24','wb') as fp:
