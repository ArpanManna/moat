...
attackers = [3,6,9,10,13,16,18,24,26]
...
with open('fashion_mnist_ba_plus_acc_9','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('fashion_mnist_ba_plus_basr_9','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list,fp)
with open('fashion_mnist_ba_plus_rounds_9','wb') as fp:
