...
with open('fashion_mnist_ba_pattern_acc_6','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('fashion_mnist_ba_pattern_basr_6','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list,fp)
with open('fashion_mnist_ba_pattern_rounds_6','wb') as fp:
