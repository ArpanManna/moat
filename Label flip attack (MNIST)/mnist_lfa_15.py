...
attackers = [1,3,5,7,9,13,15,16,17,19,20,21,23,25,27]
...
with open('accuracy_fashion_lfa_15','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('comm_rounds_fashion_lfa_15','wb') as fp:
  pickle.dump(global_communication_rounds,fp)
with open('mcr_lfa_15','wb') as fp:
  pickle.dump(global_misclassification_rates,fp)
with open('t_mcr_lfa_15','wb') as fp:
  pickle.dump(global_target_misclassification_rates,fp)
with open('asr_lfa_15','wb') as fp:
