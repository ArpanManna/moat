...
with open('fm_acc_trimmedMean','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('fm_basr_trimmedMean','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list,fp)
with open('fm_rounds_trimmedMean','wb') as fp:
  pickle.dump(global_communication_rounds,fp)
with open('fm_asr_trimmedMean','wb') as fp:
  pickle.dump(global_attack_success_rates_list,fp)
with open('fm_mcr_trimmedMean','wb') as fp:
  pickle.dump(global_misclassification_rates,fp)
with open('fm_tmcr_trimmedMean','wb') as fp:
