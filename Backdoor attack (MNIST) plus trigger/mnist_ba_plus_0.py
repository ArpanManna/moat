...
print("Running  Federated Learning with 0% attacker")
...
with open('mnist_ba_plus_acc_0','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('mnist_ba_plus_basr_0','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list,fp)
with open('mnist_ba_plus_rounds_0','wb') as fp:
