...
poisoned_sample, attack_success_rate, misclassification_rates,acc_test, backdoor_acc_test, global_updates, client_local_updates, rounds ,euclid_dists ,autoencoder_results, shap_data = run(attackers,6,2,-1,local_data_fl, test_data_1, backdoor_test_data,False)
...
with open('mnist_ba_plus_acc_15','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('mnist_ba_plus_basr_15','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list,fp)
with open('mnist_ba_plus_rounds_15','wb') as fp:
