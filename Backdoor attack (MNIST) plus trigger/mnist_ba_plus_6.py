...
print("Running  Federated Learning with 20% attacker and defense")
local_data_fl = copy.copy(clients_data)
attackers = [2,4,14,17,23,27]
...
with open('mnist_ba_plus_acc_6','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('mnist_ba_plus_basr_6','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list,fp)
with open('mnist_ba_plus_rounds_6','wb') as fp:
