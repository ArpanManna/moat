...
attackers = [1,2,3,5,7,9,10,11,13,15,16,17,19,20,21,22,23,25,26,27,29]
...
with open('mnist_ba_plus_acc_21','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('mnist_ba_plus_basr_21','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list,fp)
with open('mnist_ba_plus_rounds_21','wb') as fp:
