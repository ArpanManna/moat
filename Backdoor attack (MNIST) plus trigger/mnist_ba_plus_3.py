...
print("Running  Federated Learning with 10% attacker")
...
print("Running  Federated Learning with 10% attacker and defense")
local_data_fl = copy.copy(clients_data)
attackers = [3,6,9]
...
with open('mnist_ba_plus_acc_3','wb') as fp:
  pickle.dump(global_accuracy_list,fp)
with open('mnist_ba_plus_basr_3','wb') as fp:
  pickle.dump(global_backdoor_accuracy_list,fp)
with open('mnist_ba_plus_rounds_3','wb') as fp:
